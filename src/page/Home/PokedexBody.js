...
function PokedexBody(props){
  ...
  function renderImg(id){
    if(id<10){
      return <img className="card-image flying" src={`https://assets.pokemon.com/assets/cms2/img/pokedex/full/00${id}.png`}/>
    }else if(id<100){
      return <img className="card-image flying" src={`https://assets.pokemon.com/assets/cms2/img/pokedex/full/0${id}.png`}/>

    }else{
      return <img className="card-image flying" src={`https://assets.pokemon.com/assets/cms2/img/pokedex/full/${id}.png`}/>
    }
